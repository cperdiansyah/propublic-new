 ...
 * Handles OAuth provider sign-in buttons
...
export const SocialSignIn = ({ onSocialLogin }: SocialSignInProps) => (
 ...
 * Individual social provider button
 */
...
const SocialButton = ({ provider, onClick }: SocialButtonProps) => {
  ...
  return (
    ...
    >
      ...
      <span className="font-teko text-xl mt-1">{config.name}</span>
    </button>
  )
}
 ...
 * Defines social authentication providers
 */
